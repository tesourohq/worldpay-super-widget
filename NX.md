...
This repo is an [Nx](https://nx.dev) workspace. Nothing here is specific to the
widget — see the [README](./README.md) for that. This file collects the
workspace tooling: running targets, generating projects, and CI.
